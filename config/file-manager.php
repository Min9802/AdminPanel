...
use Min\FileManager\Services\ACLService\ConfigACLRepository;
use Min\FileManager\Services\ConfigService\DefaultConfigRepository;
...
return [
     ...
     */
    'routePrefix' => 'api/v1/fm',

    /**
     * List of disk names that you want to use
     * (from config/filesystems)
     */
    'diskList' => ['public', 'nextcloud'],
    ...
    /**
     * Hide files and folders from api/v1/admin/fm if user doesn't have access
     *
     * ACL access level = 0
     */
    'aclHideFromFM' => true,
